...
def incidentTitle() :
    ...
    print("incidentTitle : " + incidentTitle.decode(sys.stdout.encoding, errors='replace'))
    ...
    print("description_text : " + description_text.decode(sys.stdout.encoding, errors='replace'))
